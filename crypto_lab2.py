...
class CipherApp:
    ...
    def create_widgets(self):
        ...
        # Key Input
        tk.Label(self.root, text="Enter Key (int, tuple, or passphrase):").pack(pady=5)
    ...
    def show_about(self):
        messagebox.showinfo("About",
                                "Cipher Application v2.0\n"
                                "Developed by Dmytro Mikhno TV-12.\n"
                                "Supports Caesar and Trithemius ciphers.\n"
